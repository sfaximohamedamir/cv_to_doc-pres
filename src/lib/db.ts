...
// S'assurer que le dossier de la base SQLite existe et que le schéma est initialisé
...
if (dbUrl.startsWith('file:')) {
  ...
  try {
    ...
    // Si le fichier db n'existe pas encore (ex: /tmp/ sur Render), initialiser le schéma
